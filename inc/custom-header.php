...
add_action( 'after_setup_theme', 'testscores_custom_header_setup' );

if ( ! function_exists( 'testscores_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see testscores_custom_header_setup().
 */
function testscores_header_style() {
