<?php
/**
 * Testscores functions and definitions.
 *
...
if ( ! function_exists( 'testscores_setup' ) ) :
/**
 ...
 */
function testscores_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Testscores, use a find and replace
	 * to change 'testscores' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'testscores', get_template_directory() . '/languages' );
	...
	add_image_size( 'testscores-small-thumb', 300, 150, true ); 

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'testscores' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'testscores_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'testscores_setup' );
...
function testscores_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'testscores' ),
...
//        wp_enqueue_style('testscores-google-fonts','https://fonts.googleapis.com/css?family=Fira+Sans:400,400italic,700,700italic|Merriweather:400,400italic,700,700italic');
	...
	wp_enqueue_style( 'popperscores-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css' );
               	...
               	wp_enqueue_script( 'testscores-navigation', get_template_directory_uri() . '/js/functions.js', array( 'jquery'), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'testscores_scripts' );
